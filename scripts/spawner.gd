...
# Referencias a escenas de NPCs precargadas
...
func _ready() -> void:
	...
	# Si no se configuraron por exportación, buscar hijos Marker3D
	...
	# Buscar HUD para actualizar tiempo restante
...
func spawn_wave() -> void:
	...
	for i in range(spawn_count_per_cycle):
		...
		# Distribución de tipos: 50% melee, 30% pistolero, 20% escopetero
